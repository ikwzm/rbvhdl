...
describe 'RbVHDL::Ast::Declaration::Alias' do
  ...
  context "new" do
    ...
    it "new(nil, identifier('a_vec'), nil, name('a')))" do
      decl = RbVHDL::Ast::Declaration::Alias.new(nil, RbVHDL::Ast.identifier('a_vec'), nil, RbVHDL::Ast.name('a'))
    ...
    it "RbVHDL::Ast.alias_declaration(nil, 'a_vec', nil, 'a')" do
      decl = RbVHDL::Ast.alias_declaration(nil, 'a_vec', nil, 'a')
      expect(decl.class                               ).to eq RbVHDL::Ast::Declaration::Alias
      expect(decl._owner                              ).to eq nil
      expect(decl._identifier.class                   ).to eq RbVHDL::Ast::Identifier
      expect(decl._identifier                         ).to eq :a_vec
    ...
    it "RbVHDL::Ast.alias_declaration(nil, 'a_val', 'integer', 'a')" do
      decl = RbVHDL::Ast.alias_declaration(nil, 'a_val', 'integer', 'a')
      expect(decl.class                                     ).to eq RbVHDL::Ast::Declaration::Alias
      expect(decl._owner                                    ).to eq nil
      expect(decl._identifier.class                         ).to eq RbVHDL::Ast::Identifier
    ...
    it "RbVHDL::Ast.alias_declaration(nil, 'a_val', 'integer', 'a', signature('integer', 'integer')._return!('integer'))" do
      decl = RbVHDL::Ast.alias_declaration(nil, 'a_val', 'integer', 'a', RbVHDL::Ast.signature('integer', 'integer')._return!('integer'))
      expect(decl.class                                     ).to eq RbVHDL::Ast::Declaration::Alias
      expect(decl._owner                                    ).to eq nil
      expect(decl._identifier.class                         ).to eq RbVHDL::Ast::Identifier
      expect(decl._identifier                               ).to eq :a_val
