...
describe 'RbVHDL::Ast::Declaration::ArchitectureBody' do
    ...
    it "sig1_decl = body._constant_declaration('sig1', 'INT08_TYPE', nil, 5)" do
      ...
      expect(sig1_decl._subtype_indication._type_mark.class            ).to eq RbVHDL::Ast::Expression::SimpleName
      expect(sig1_decl._subtype_indication._type_mark._name.class      ).to eq RbVHDL::Ast::Identifier
      expect(sig1_decl._subtype_indication._type_mark._name            ).to eq :INT08_TYPE
    ...
    it "sig2_decl = body._signal_declaration('sig2', 'FLOAT_TYPE', nil, nil)" do
      ...
      expect(sig2_decl._subtype_indication._type_mark.class            ).to eq RbVHDL::Ast::Expression::SimpleName
      expect(sig2_decl._subtype_indication._type_mark._name.class      ).to eq RbVHDL::Ast::Identifier
      expect(sig2_decl._subtype_indication._type_mark._name            ).to eq :FLOAT_TYPE
    ...
    it "sig3_decl = body._signal_declaration(  'sig3', 'STATE_TYPE', nil, 'IDLE_STATE')" do
      ...
      expect(sig3_decl._subtype_indication._type_mark.class            ).to eq RbVHDL::Ast::Expression::SimpleName
      expect(sig3_decl._subtype_indication._type_mark._name.class      ).to eq RbVHDL::Ast::Identifier
      expect(sig3_decl._subtype_indication._type_mark._name            ).to eq :STATE_TYPE
